...
function szEnsureDefaults() {
  if (!localStorage.getItem(SZ_KEYS.settings)) {
    szWrite(SZ_KEYS.settings, SOFTWAREZAWY_DEFAULTS.settings);
  } else {
    ...
    szWrite(SZ_KEYS.settings, mergedSettings);
  }
  if (!localStorage.getItem(SZ_KEYS.sections)) szWrite(SZ_KEYS.sections, SOFTWAREZAWY_DEFAULTS.sections);
  if (!localStorage.getItem(SZ_KEYS.products)) szWrite(SZ_KEYS.products, SOFTWAREZAWY_DEFAULTS.products);
  if (!localStorage.getItem(SZ_KEYS.coupons)) szWrite(SZ_KEYS.coupons, SOFTWAREZAWY_DEFAULTS.coupons);
  if (!localStorage.getItem(SZ_KEYS.managers)) szWrite(SZ_KEYS.managers, SOFTWAREZAWY_DEFAULTS.managers);
}
